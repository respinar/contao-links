 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_links']['new']            = array('New link','Add a new link');
$GLOBALS['TL_LANG']['tl_links']['copy']           = array('Copy link','Copy link ID %s');
$GLOBALS['TL_LANG']['tl_links']['cut']            = array('Move link','Move link ID %s');
$GLOBALS['TL_LANG']['tl_links']['delete']         = array('Delete link','Delete link ID %s');
